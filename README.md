...
* [Credit risk modeling](https://github.com/jalajthanaki/credit-risk-modelling): Predictive analytics model which will predict whether the customer will default the loan or not.
